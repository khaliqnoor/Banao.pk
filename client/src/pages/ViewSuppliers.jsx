...
const ViewSuppliers = () => {
  ...
  <div className="flex-1 flex flex-col items-center px-4 md:px-16 py-8 md:py-16">
    ...
    <div className="w-full max-w-2xl mt-8">
      ...
      {/* Placeholder for recommended supplier cards */}
     
        {/* Supplier Card */}
 <div className="flex flex-wrap gap-6 mt-7 justify-center md:justify-start w-full">
{/* supplier3 */}

   <div className="w-full sm:w-[45%] md:w-[45%] lg:w-[45%]  max-w-sm flex flex-col items-center bg-[#939191] rounded-2xl shadow-md p-4">
  {/* Active Status */}
  ...
  <div className="flex w-full justify-between mt-6">
    <button onClick={()=> navigate('/view-suppliers/profile')} className="w-1/2 text-center cursor-pointer mr-2 bg-[#464646] text-[#D9D9D9] font-semibold py-2 rounded-lg hover:bg-[#555] transition">
       View Profile
    </button>
